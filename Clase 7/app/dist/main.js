...
//let test = require("./test") //require es de Node. CommonJS
 //Es lo mismo. Forma nueva.


var a = 2000;
console.log(a);
_test__WEBPACK_IMPORTED_MODULE_0___default.a.saludo("Juan"); //let component = ()=> <p>Hola</p>
